...
# Set up database
engine = create_engine("postgres://iyvjlwlzqgqgbm:5790b26a26e1b18dbd4fd00a93125d01db5701f3bdc3771bf71fd816506e6c40@ec2-52-71-55-81.compute-1.amazonaws.com:5432/dtoivsgpueo8i")
...
def bookpage(isbn):
    ...
    res = requests.get("https://www.goodreads.com/book/review_counts.json", params={"key": 'MtcoCFG3Cx24OSZ7MSfYRQ', "isbns": isbn})
    response = res.json()
